...
Hitro opazimo, da sta si grafa precej podobna. 
...
Za zaključek sem z dvema metodama za napovedovanje časovnih vrst probal predvideti ceno BTC. V grafu je napoved za 30 dni vnaprej z vgrajeno metodo `ETS(Exponential smoothing state space model)`.
