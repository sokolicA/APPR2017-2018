...
Za zaključek sem z dvema metodama za napovedovanje časovnih vrst probal predvideti ceno BTC. V grafu je na podlagi 365 opazovanj iz prejšnjega leta napoved za 30 dni vnaprej z vgrajeno metodo `ETS(Exponential smoothing state space model)`. S svetlejše modro je prikazan 95% interval zaupanja, s temnejšo pa 80% interval zaupanja.
